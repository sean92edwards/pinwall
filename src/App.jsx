...
function HorizontalWall({session,muted,editing,setEditing,username}){
  ...
  return(
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:"calc(-1 * env(safe-area-inset-bottom, 0px))",display:"flex",flexDirection:"column"}}>
      ...
      {editing&&showPhotoMenu&&createPortal(<div onClick={()=>setShowPhotoMenu(false)} style={{position:"fixed",inset:0,zIndex:9999,display:"flex",alignItems:"flex-end",justifyContent:"center",paddingBottom:"calc(80px + env(safe-area-inset-bottom, 0px))"}}>
        <div onClick={e=>e.stopPropagation()} style={{background:"#fffdf8",border:"1px solid #ece1cf",borderRadius:12,padding:10,boxShadow:"0 12px 36px rgba(80,60,20,0.22)",width:170}}>
      ...
      {editing&&showStickers&&createPortal(<div onClick={()=>setShowStickers(false)} style={{position:"fixed",inset:0,zIndex:9999,display:"flex",alignItems:"flex-end",justifyContent:"center",paddingBottom:"calc(80px + env(safe-area-inset-bottom, 0px))",paddingLeft:16,paddingRight:16}}>
        <div onClick={e=>e.stopPropagation()} style={{background:"#fffdf8",border:"1px solid #ece1cf",borderRadius:14,padding:12,boxShadow:"0 12px 36px rgba(80,60,20,0.22)",width:"100%",maxWidth:264}}>
      ...
      {editing&&showNoteMenu&&createPortal(<div onClick={()=>setShowNoteMenu(false)} style={{position:"fixed",inset:0,zIndex:9999,display:"flex",alignItems:"flex-end",justifyContent:"center",paddingBottom:"calc(80px + env(safe-area-inset-bottom, 0px))"}}>
        <div onClick={e=>e.stopPropagation()} style={{background:"#fffdf8",border:"1px solid #ece1cf",borderRadius:12,padding:10,boxShadow:"0 12px 36px rgba(80,60,20,0.22)",width:160}}>
