...
function HorizontalWall({session,muted}){
  ...
  return(
    <div style={{height:"calc(100dvh - 58px)",position:"relative",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{position:"absolute",top:-50,right:220,zIndex:200,display:"flex",gap:8,alignItems:"center"}}>
        ...
        <button onClick={()=>{setEditing(e=>!e);setSelected(null);setEditingText(null);setShowStickers(false);}} style={{display:"inline-flex",alignItems:"center",gap:4,padding:"6px 12px",borderRadius:20,border:"none",cursor:"pointer",fontFamily:"'Nunito',sans-serif",fontSize:11,fontWeight:700,background:editing?"#2a9d8f":"#2c2620",color:"#fff"}}>{editing?"✓ Done":"✏️ Edit"}</button>
      </div>
