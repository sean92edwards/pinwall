...
function HorizontalWall({session,muted,editing,setEditing,username}){
  ...
  return(
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:"calc(-1 * env(safe-area-inset-bottom, 0px))",display:"flex",flexDirection:"column"}}>
      ...
      {editing&&showPhotoMenu&&createPortal(<div onClick={()=>setShowPhotoMenu(false)} style={{position:"fixed",bottom:"calc(80px + env(safe-area-inset-bottom, 0px))",left:0,right:0,display:"flex",justifyContent:"center",zIndex:9999,pointerEvents:"auto"}}>
      ...
      {editing&&showStickers&&createPortal(<div onClick={()=>setShowStickers(false)} style={{position:"fixed",bottom:"calc(80px + env(safe-area-inset-bottom, 0px))",left:16,right:16,display:"flex",justifyContent:"center",zIndex:9999,pointerEvents:"auto"}}>
      ...
      {editing&&showNoteMenu&&createPortal(<div onClick={()=>setShowNoteMenu(false)} style={{position:"fixed",bottom:"calc(80px + env(safe-area-inset-bottom, 0px))",left:0,right:0,display:"flex",justifyContent:"center",zIndex:9999,pointerEvents:"auto"}}>
