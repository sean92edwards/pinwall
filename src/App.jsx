...
function HorizontalWall({session,muted,editing,setEditing,username}){
  ...
  return(
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:"calc(-1 * env(safe-area-inset-bottom, 0px))",display:"flex",flexDirection:"column"}}>
      ...
      {editing&&showPhotoMenu&&<div onClick={()=>setShowPhotoMenu(false)} style={{position:"fixed",bottom:"calc(80px + env(safe-area-inset-bottom, 0px))",left:0,right:0,margin:"0 auto",background:"#fffdf8",border:"1px solid #ece1cf",borderRadius:12,padding:10,zIndex:201,boxShadow:"0 12px 36px rgba(80,60,20,0.22)",width:170}}>
      ...
      {editing&&showStickers&&<div onClick={()=>setShowStickers(false)} style={{position:"fixed",bottom:"calc(80px + env(safe-area-inset-bottom, 0px))",left:16,right:16,margin:"0 auto",background:"#fffdf8",border:"1px solid #ece1cf",borderRadius:14,padding:12,zIndex:201,boxShadow:"0 12px 36px rgba(80,60,20,0.22)",maxWidth:264}}>
      ...
      {editing&&showNoteMenu&&<div onClick={()=>setShowNoteMenu(false)} style={{position:"fixed",bottom:"calc(80px + env(safe-area-inset-bottom, 0px))",left:0,right:0,margin:"0 auto",background:"#fffdf8",border:"1px solid #ece1cf",borderRadius:12,padding:10,zIndex:201,boxShadow:"0 12px 36px rgba(80,60,20,0.22)",width:160}}>
