  ...
  return(
    <div style={{fontFamily:"'Nunito',sans-serif",background:"#f3ead9",minHeight:"100vh"}}>
      ...
      <div className="pinwall-nav" style={{position:"fixed",top:0,left:0,right:0,zIndex:100,padding:"16px 20px",display:"flex",alignItems:"center",justifyContent:"space-between",pointerEvents:"none"}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:8,pointerEvents:"auto"}}>
          <button onClick={()=>{setEditing(e=>{if(e){setShowStickers(false);setShowNoteMenu(false);setShowPhotoMenu(false);setDoodling(false);setErasing(false);setSelected(null);}return!e;});}} style={{display:"inline-flex",alignItems:"center",justifyContent:"center",padding:"8px 16px",borderRadius:24,border:"none",cursor:"pointer",fontSize:12,fontFamily:"'Nunito',sans-serif",fontWeight:700,background:editing?"#2a9d8f":"rgba(30,30,30,0.85)",color:"#fff",boxShadow:"0 2px 8px rgba(0,0,0,0.3)",gap:6}}>{editing?"✓ Done":"✏️ Edit wall"}</button>
          <div style={{position:"relative"}}>
